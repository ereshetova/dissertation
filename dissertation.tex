...
% Add the dissertation author's contribution to that publication.
\addcontribution{The author did the analysis of the BPF JIT implementation and developed the initial versions of both BPF JIT Spray attack approaches described in this publication. Author also participated in the attack evaluation efforts, as well as led the writing of the publication.}
% No errata
% Add the publication pdf file, the filename is the parameter.
